...
<body>
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <div class="navbar-header"><a class="navbar-brand navbar-link" href="#">RTO SYSTEM </a>
    ...
    <div class="login-card"><img src="assets/img/avatar_2x.png" class="profile-img-card">
        ...
        <form class="form-signin" action="login.php" method="POST"><span class="reauth-email"> </span>
            ...
            <button class="btn btn-primary btn-block btn-lg btn-signin" type="submit" name='submit'>Login </button>
